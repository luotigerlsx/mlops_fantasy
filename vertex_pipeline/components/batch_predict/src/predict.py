...
def batch_predict(
    ...
    Args:
        ...
        gcs_scoring_result_folder: The GCS folder to store the scoring results in CSV format.
    ...
    scoring_result_uri = os.path.join(gcs_scoring_result_folder,
    ...
    worker_pool_specs = [
        {
            ...
            "container_spec": {
                ...
                "args": [
                    ...
                    '--endpoint_resource_name', input_endpoint.uri[len(VERTEX_AI_RESOURCE_PREFIX):]
                ]
            }
        }
    ]
