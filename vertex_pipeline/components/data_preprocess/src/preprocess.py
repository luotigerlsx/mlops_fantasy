...
def preprocess_data(
    ...
    input_project, input_dataset, input_table = _bq_uri_to_fields(input_dataset.uri)
    ...
    destination_uri = os.path.join(gcs_output_folder, f'processed_data-{timestamp}.csv')
